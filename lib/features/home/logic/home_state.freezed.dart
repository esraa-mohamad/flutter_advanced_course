...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<SpecializationDate?>? specializationData)
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<SpecializationDate?>? specializationData)?
        specializationSuccess,
...
abstract class SpecializationLoading implements HomeState {
  factory SpecializationLoading() = _$SpecializationLoadingImpl;
}
...
abstract class _$$SpecializationSuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<SpecializationDate?>? specializationData});
}
...
class _$SpecializationSuccessImpl implements SpecializationSuccess {
  _$SpecializationSuccessImpl(
      final List<SpecializationDate?>? specializationData)
      : _specializationData = specializationData;

  final List<SpecializationDate?>? _specializationData;
  @override
  List<SpecializationDate?>? get specializationData {
...
class _$SpecializationErrorImpl implements SpecializationError {
  _$SpecializationErrorImpl(this.errorHandler);
...
abstract class SpecializationError implements HomeState {
  factory SpecializationError(final ErrorHandler errorHandler) =
...
class _$DoctorsSuccessImpl implements DoctorsSuccess {
  _$DoctorsSuccessImpl(final List<Doctors?>? doctorsList)
...
abstract class DoctorsSuccess implements HomeState {
  factory DoctorsSuccess(final List<Doctors?>? doctorsList) =
...
class _$DoctorsErrorImpl implements DoctorsError {
  _$DoctorsErrorImpl(this.errorHandler);
...
abstract class DoctorsError implements HomeState {
  factory DoctorsError(final ErrorHandler errorHandler) = _$DoctorsErrorImpl;
